                                          ...
                                          .then(arr_vc => {
                                            if(arr_vc[0] != ""){
                                              ...
                                              TINH.findAll({
                                                ...
                                                .then(arrTinhs => {
                                                  res.render("admin/duongsu/edit_cn1.ejs", {
                                                    data1: arr,
                                                    data2: arrqh,
                                                    data3: arrpx,
                                                    data4: arrTinh,
...
app.post('/admin/duongsu_cn/edit/:id', urlencodedParser, function(req, res) {
  ...
  if (us == 0) {
    res.redirect('/admin/duongsu_cn/edit/:id');
  } else if (cmnd == cmnd_vc) {
    temp = -5;
    res.redirect('/admin/duongsu_cn/edit/:id');
  }else {
    DUONGSU_CANHAN.findOne({where: {id: i}})
    .then(DSCN =>{
      if(DSCN.tt_honnhan == 1 && (honnhan == 1 || honnhan == 3 || honnhan == 4)){
        DUONGSU_CANHAN.update({
          HOTEN: hoten,
          GIOITINH: gioitinh,
          NGAYSINH: ngaysinh,
        ...
        res.redirect('/admin/duongsu_cn')
      }else if(DSCN.tt_honnhan == 1 && honnhan == 2) {
        //bảng hôn nhân
        so_dk = req.body.so_dk;
        so_quyen = req.body.so_quyen;
        ngaycap_gcn = req.body.ngaycap_gcn;
      ...
      res.redirect('/admin/duongsu_cn')
    }else if (DSCN.tt_honnhan == 2 && (honnhan == 1 || honnhan == 4)) {
        DUONGSU_CANHAN.update({
          HOTEN: hoten,
          GIOITINH: gioitinh,
          NGAYSINH: ngaysinh,
        ...
        res.redirect('/admin/duongsu_cn')
    }else if (DSCN.tt_honnhan == 2 && honnhan == 2) {
      //bảng hôn nhân
      so_dk = req.body.so_dk;
      so_quyen = req.body.so_quyen;
      ngaycap_gcn = req.body.ngaycap_gcn;
